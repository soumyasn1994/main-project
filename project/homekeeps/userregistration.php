            ...
            ?>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" value="<?php if(isset($_SESSION['email'])) { 
                        echo $_SESSION['email'];
                        } ?>" placeholder="example@email.com" class="av-email form-control" av-message="Enter valid email address">
                </div>
                <div class="form-group">
                    <label for="username">Username:</label>
                    <input type="text" name="un" id="un"  placeholder="Enter your Username" class="av-username form-control" av-message="Invalid Username(Contain a-z,A-Z,0-9,.and _ (3-32 chars))">
                </div>
                <div class="form-group">
                    <label for="pwd">Password:</label>
                    <input type="password" name="pwd"  id="pwd" placeholder="Enter your Password" class="av-password form-control" av-message="Invalid password(Password must contain uppercase,lowercase,special chars,digits and minimum 6 chars.)">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="av-image form-control" name="fileupload" accept="image/*" size="70" id="fileupload" />
                </div>
                <div class="form-group">
