...
$id=$_SESSION['Log_id'];
 $qry ="SELECT * From tb_regemployee WHERE Status='0'";
...
echo "<td><a href='data/aprov.php?id=".$employee['Emp_id']."' onClick=\"return confirm('Are you sure you want to Approve?')\"  >APPROVE</a> |<a href='data/deletes.php?id=".$employee['Emp_id']."' onClick=\"return confirm('Are you sure you want to delete?')\">DELETE</a></td>";
