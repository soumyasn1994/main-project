            ...
            <div class="container-fluid">
                <div class="row headder-contact">
                    <div class="hedder-up col-lg-6 col-md-6 col-sm-6">
                        <h1><a class="navbar-brand" href="index.php">Mansion Care</a></h1>
                    </div>
                    ...
                    <div class="collapse navbar-collapse  nav-fill " id="navbarSupportedContent">
                        <ul class="navbar-nav nav-pills nav-fill">
                            ...
                            <li class="nav-item active">
                                <a href="service.php" class="nav-link ">Profile</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="gallery.php" class="nav-link">Contact</a>
                            </li>
    ...
    <table width="100%" border="20" cellpadding="20" cellspacing="20">
        ...
        <?php
         ...
         if (isset($_GET['submit'])) {
            // echo $sql = "SELECT * FROM tb_service";
            // $result = $con->query($sql);
            $sqls = "select DISTINCT(p.Place) from tb_regsuser as t,tb_login as l,tb_place as p where l.roleid='2' and p.Pid=t.Pid and l.Log_id=t.Log_id";
            //select * from tb_regsuser as t,tb_login as l,tb_place as p where l.roleid='2' and p.Pid=t.Pid ";
            $re = $con->query($sqls);
            ...
            <center>
<tr><td colspan="3">                <h1>BOOK NOW</h1></td></tr>
            </center><br>
            <!-- <tr>
        ...
        ?> <option value="<//?php echo $rowm['service_id']; ?>"><//?php echo $rowm['service_name']; ?> </option>
            ...
            <tr>
               ...
               ?>
                ...
                <!-- <td><input type="text" placeholder="Enter your Location" class="av-name form-control" av-message="Invalid Place" name="loc"></td> -->
            </tr><br>
            <tr>
                ...
                <td>
                    ...
                    <center><input type="submit" value="Submit request" name="bookdate"></center>
                </td>
            </tr>
        </form>
    </table>
    ...
    <div class="copy-agile-right text-center py-3">
        <h2 class="my-3"><a href="index.php">RENOVATE</a></h2>
        <p>
