...
<html lang="zxx">
   <head>
      <title> Mansion a services Category Flat Bootstrap Responsive Web Template | Contact :: w3layouts</title>
      <!--meta tags -->
      <meta charset="UTF-8">
            ...
            <div class="agile-info-para">
               <form action="#" method="post">
                  <div class="row agile-wls-contact-mid">
                     ...
                     <div class="col-md-6 form-group contact-forms">
                     <input class="form-control" type="text" placeholder="Select your Birth Date" value="1986-10-01" name="date" required="" id="date" readonly>
                        </div>
                        <div class="col-md-6 form-group contact-forms">
