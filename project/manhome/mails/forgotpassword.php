...
if (isset($_POST['submits'])) {
	$email=$_POST['email'];
	$sqs="SELECT * FROM tb_login WHERE Username='$email'";
	$result=mysqli_query($con,$sqs);
	$row=mysqli_fetch_assoc($result);
    $a=$row['Username'];
    $b=$row['Log_id'];
//    $lidres="SELECT * FROM kalolsavam_tb1_login WHERE Log_id='$b'";
...
$mail->addAddress($row["Username"]);
  ...
  $mail->AltBody = "For Change password enter your  OTP in ";
  if(!$mail->send())
   {
...
<div class="container" style="margin-top: 100px">
	...
	<div class="col-md-6 col-md-offset-3" align="center">
		<img src="../images/forgot.gif"><br><br>
