...
header('location:index.php');
 ...
 $id=$_SESSION['Log_id'];
 $sql = "select * from tb_regsuser as r join tb_empserv as e on r.Log_id=e.Log_id join tb_login as l on l.Log_id=r.Log_id left join tb_place on r.Pid = tb_place.Pid left join tb_district on tb_place.Did = tb_district.Did left join tb_category on tb_category.cat_id = e.cat_id where l.roleid='2' and l.status='1' and l.Log_id!='$id'";
...
<html>
<head>
<link rel="stylesheet" href="Userhome1/webs/style/public/css/bootstrap.min.css">
...
<div class="topnav">
  <a class="active" href="staff.php">Home</a><br>
...
while($row=mysqli_fetch_array($result))
	...
	<img src="<?php echo $row['Photo']?>" style="width:120px; height:120px; margin-left:20%;" class="p-3"><br>
	
	<br><input class="form-control" type="text" name="Name" value="<?php echo $row['first_name']." ". $row['last_name']?>"><br>
