            ...
            <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h3><a href="user_home.php">MANSION CARE</a></h3>
							</div>
					<div class="w3layouts-left">
							
							<!--search-box-->
								<div class="w3-search-box">
									<form action="../webs/usersersearch.php" method="get" onchange="sersearch.php">
									
									<select class="form-control mr-sm-2" name="wp">
        
						?> <option value="Searchs...">--search for a service--</option>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src='<?php echo "../../$img"; ?>'alt=""> </span> 
												<div class="user-name">
													<p>Welcome</p>
													<span>
