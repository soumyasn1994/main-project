...
<html lang="zxx">
   ...
   <body>
            ...
            <div class="container-fluid">
               <div class="row headder-contact">
                  <div class="hedder-up col-lg-6 col-md-6 col-sm-6">
                     <h1><a class="navbar-brand" href=" user.html">Mansion Care</a></h1>
                  </div>
      ...
      <section class="about-inner py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <div class="title-sub text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
               ...
               <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do<br>tempor incididunt ut labore </p> -->
            </div>
            <div class="row">
      ...
      <div class="copy-agile-right text-center py-3">
         <h2 class="my-3"><a href=" user.html">Mansion Care</a></h2>
         <p> 
