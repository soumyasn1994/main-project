            ...
            <div class="container-fluid">
               <div class="row headder-contact">
                  <div class="hedder-up col-lg-6 col-md-6 col-sm-6">
                     <h1><a class="navbar-brand" href="#"> Mansion</a></h1>
                  </div>
            ...
            <div class="agile-info-para">
               <form action="#" method="post">
                  ...
                  <div class="form-group contact-forms">
                     <textarea class="form-control" rows="3"  id="msg" name="msg" placeholder="Message.." required=""></textarea>
                  </div>
                  <div class="text-left click-subscribe">
                     <button type="submit" name="submit" id="submit" class="btn contact-btn">Send</button>
                  </div>
               </form>
            </div>
         </div>
