            ...
            <div class="container-fluid">
               <div class="row headder-contact">
                  <div class="hedder-up col-lg-6 col-md-6 col-sm-6">
                     <h1><a class="navbar-brand" href="../userhome.html"> Mansion</a></h1>
                  </div>
      ...
      <section class="service-one py-lg-4 py-md-3 py-sm-3 py-3" id="about">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            <div class="title-sub text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
               <h3 class="title mb-md-4 mb-sm-3 mb-3">Our Cleaning Services</h3>
            ...
            <div class="row">
               <div class="col-lg-4 col-md-6 col-sm-6 service-inner-list">
                  <div class="ser-inner-agile">
                     ...
                     <div class="nav-item">
                        ...
                        <a href="bookings.php" class="nav-link">Book Now -->
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 service-inner-list">
                  <div class="ser-inner-agile">
                     ...
                     <div>
                        <h4 class="py-3"><a href=../cleanempo.php> Appartment Cleaning</a></h4>
                        <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nibh urna, euismod ut ornare non</p>
                       <p> <a href="bookings.php" class="nav-link">Book Now</a></p> -->
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 service-inner-list">
                  <div class="ser-inner-agile">
                     ...
                     <div class="ser-txt-inner">
                        <h4 class="py-3"><a href=../cleanempo.php>Room Cleaning</a></h4>
                        <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nibh urna, euismod ut ornare non</p>
                        <a href="bookings.php" class="nav-link">Book Now</a> -->
                     </div>
                  </div>
               </div>
               <!--<div class="col-lg-4 col-md-6 col-sm-6 mt-lg-4 mt-md-3 mt-3 service-inner-list">
                  <div class="ser-inner-agile">
                     ...
                     <!-- <div class="ser-txt-inner">
                        <h4 class="py-3">Home Maintenance</h4>
                        <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nibh urna, euismod ut ornare non</p>
                        <a href="bookings.php" class="nav-link">Book Now</a> 
                     </div>
                  </div>
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-6 wthree-left-right">
                        ...
                        <nav class="border-line">
                           <ul class="nav flex-column">
                              <li class="nav-item active">
                                 <a class="nav-link" href="../userhome.html">Home <span class="sr-only">(current)</span></a>
                              </li>
                              <li class="nav-item">
