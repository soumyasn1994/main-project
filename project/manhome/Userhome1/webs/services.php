...
<html lang="zxx">
   <head>
      <title>Mansion a services Category Flat Bootstrap Responsive Web Template | Home :: w3layouts</title>
      <!--meta tags -->
      <meta charset="UTF-8">
...
<body>
            ...
            <div class="container-fluid">
               <div class="row headder-contact">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 search-right">
                     <form action="sersearch.php" method="get" class="form-inline my-lg-0">
                     <select class="form-control mr-sm-2" name="wp">
    ...
    ?>
                        ...
                        <!-- <input type="hidden" name="sid" id="sid" value="<?php echo $row['service_id']; ?>"> -->
                  ...
                  <div class="collapse navbar-collapse  nav-fill " id="navbarSupportedContent">
                     <ul class="navbar-nav nav-pills nav-fill">
                        <li class="nav-item active">
                           <a class="nav-link" href="../user/user_home.php">Home <span class="sr-only">(current)</span></a>
                        </li>
                     ...
                     <div class="slider-img one-img">
                        <div class="container">
                           <div class="slider-info">
                              <h4>Welcome To Mansion<br>We Offer <span>75%</span> Cleaning</h4>
                              <div class="outs_more-buttn">
                                 <a href="sersearch.php">Book Now</a>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <section class="about py-lg-4 py-md-3 py-sm-3 py-3" id="about">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
			...
			<!---728x90--->
               ...
               <div class="col-lg-4 col-md-4 agile-abt-info">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 team-w3layouts-row text-center">
...
<div class="col-lg-3 col-md-6 col-sm-6 wthree-left-right">
      ...
      <div class="copy-agile-right text-center py-3">
         <h2 class="my-3"><a href="index.html">Mansion</a></h2>
         <p> 
            © 2018 Mansion. All Rights Reserved | Design by <a href="http://www.W3Layouts.com" target="_blank">W3Layouts</a>
         </p>
      </div>
      <!--//footer-->
