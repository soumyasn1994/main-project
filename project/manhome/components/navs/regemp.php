						...
						<div class="collapse navbar-collapse navbar-toggle" id="navbarNavAltMarkup1">
							<div class="navbar-nav secondfix ml-lg-auto">
								<ul class="navbar-nav text-left">
									...
									<!--<li class="nav-item">
										<a class="nav-link" href="bookdetail.php">Job Request</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="data\profile.php">Profile</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="empdetail.php">Update</a>
									</li>
									<li class="nav-item">
									...
									<li class="nav-item dropdown mr-3">
										...
										<div class="dropdown-menu text-lg-left text-center" aria-labelledby="navbarDropdown">
											<a class="dropdown-item nav-link" href="userreg.php">User</a>
											<a class="dropdown-item nav-link" href="empreg.php">Staff</a>
