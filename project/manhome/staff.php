	...
	<nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="staff.php">Mansion Care</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="jobaprov.php" class="page-scroll">job</a></li>
                        <li><a href="#tf-services" class="page-scroll">Services</a></li>
                        <li><a href="empleav.php">Apply for leave</a></li>
						
						<!-- <li><a href="mywallet.php">My Wallet</a></li>
						<li><a href="wal.php">Add Account</a></li> -->
                        <li><a href="Userhome1/user/empsersearch.php">Search</a></li>
                        <li><a href="wal.php">Add Wallet</a></li>
                        <li><a href="mywallet.php">View Wallet</a></li>
                        <li><a href="empuserrating.php">Employee Rating</a></li>
