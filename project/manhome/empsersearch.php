...
<html>
    <body>
    <div class="topnav">
  <a class="active" href="staff.php">Home</a></div>
...
if ($result->num_rows > 0) {
    ...
    ?><form id="emp" action="emposearch.php" method="post">
...
<div class="card-body">
        ...
        &nbsp;&nbsp;<input type="text" id="tdate" name="tdate" placeholder="<?php echo $cdate ?>" required>
        </div>
                <!-- <div class="card-body">
...
<script>
    ...
    <script src="Userhome1/user/js/jquery-ui.js"></script>
	<script>
//         $(document).ready(function(){
