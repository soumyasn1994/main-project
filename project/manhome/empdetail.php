...
$email=$recs['Username'];
$qry ="SELECT * From tb_regsuser as t,tb_place as p,tb_login as l, tb_district as d,tb_category as c,tb_empserv as e where t.Log_id=l.Log_id and t.Log_id=e.Log_id and t.Log_id='$id' and t.Pid=p.Pid and p.Did=d.Did and e.cat_id=c.cat_id";
//echo "$qry";
...
?>
<h5><a href="staff.php">Back to home</a></h5>
<!-- banner -->
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <form id="employee" name="employee" enctype="multipart/form-data" action="data/editse.php" class="form mt-5 mb-5 " method="post" onsubmit="return">
							<div class="form-group">	
							  	...
							  	<input id="fn" type="text" value="<?php echo "$fn" ?>" name="fn" class="form-control" onchange="fun()"  >
							</div>
							<div class="form-group">	
									<label for="first name"> Last Name:</label><br>
							  	<input id="ln" type="text" value="<?php echo "$ln" ?>" name="ln" class="form-control" onchange="fun()"  >
							</div>
                ...
                <div class="form-group">
                    ...
                    <br><input type="text" name="eh"  id="eh" value="<?php echo "$eh" ?>" class="form-control" onchange="hn()"></textarea>
								...
								<div class="form-group">
										...
										<input id="pl" name="pl" value="<?php echo "$pl" ?>" class="form-control" onchange="pl()"  >
								</div>
								<div class="form-group">
                    ...
                    <option value="India">India</option>
								...
								<div class="form-group">
										...
										<input type="email" id="email" value="<?php echo "$email" ?>" name="email" class="form-control" onchange="em()"  >
								</div>
								<div class="form-group">
                		...
                		<input type="radio" name="optradio" value="Others" <?php if($gender == "Others") echo 'checked';?>>Others
    						...
    						<!-- <div class="form-group">
										...
										<input class="form-control" type="text" value="<?php echo "$dob" ?>" name="dob"   id="dob" readonly>
								</div> -->
      					<div class="form-group">
      					...
      					<!--<div class="form-group">
										...
										<input  id="pass" type="password" value="Enter your Password" name="pass" class="av-password form-control" av-message="Invalid password"  >
								</div>-->
      					<div class="form-group">
            				...
            				<option value="select" >--select--</option>
								...
								<div class="form-group">
										...
										<input id="mob" type="text" value="<?php echo "$mob" ?>" name="mob" class="form-control" onchange="mb()"  >
								</div>
    						<div class="form-group">
										<label>Aadhar Number:</label><br>
										<input type="text" value="<?php echo "$ahr" ?>" name="ahr" id="ahr" class="form-control"onchange="ah()"  >
								</div>
								<div class="form-group">
